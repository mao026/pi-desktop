...
Pi Agent Desktop redistributes the target-specific ripgrep, fd, and agent-browser-cli executables in its default
installer. The Windows installer also includes Handsets; its Chrome extension includes a local popup security patch.
The remaining tools are fixed official releases downloaded to private application storage only after user confirmation.
...
| `agent-browser-cli`               | 0.3.7           | Bundled per target            | [MIT](https://github.com/sleepinginsummer/agent-browser/blob/bfcd4f3c94e7c9a007c8f05290cfffdb7ab4d8dd/LICENSE)                                                           | [sleepinginsummer/agent-browser](https://github.com/sleepinginsummer/agent-browser/tree/bfcd4f3c94e7c9a007c8f05290cfffdb7ab4d8dd)          |
| Handsets                          | 0.1.38          | Bundled on Windows x64        | [MIT](https://github.com/elliotgao2/handsets/blob/dbf8fe0484a566695cfdfaf952e41f700e6850ed/LICENSE)                                                                      | [elliotgao2/handsets](https://github.com/elliotgao2/handsets/tree/dbf8fe0484a566695cfdfaf952e41f700e6850ed); Copyright (c) 2026 Elliot Gao |
| Android SDK Platform-Tools        | 37.0.1          | Downloaded after confirmation | [Android SDK License](https://developer.android.com/studio/terms) and bundled `NOTICE.txt`                                                                               | [Android SDK Platform-Tools](https://developer.android.com/tools/releases/platform-tools#37.0.1)                                           |
...
The bundled ripgrep, fd, and Handsets executables are distributed with their upstream license files. The
agent-browser-cli package metadata identifies its MIT license and fixed source commit. The private platform-tools
installation retains its upstream `NOTICE.txt`; downloaded archives may contain additional components and notices,
and those upstream files remain authoritative.
